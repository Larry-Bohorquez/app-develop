function users(page){
            ...
            result.info.data.forEach(user => {
                listUsers = listUsers + `
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-outline-primary" onclick="getUser('${user.id}')">Ver</button></td>
                    </tr>
                `  
            });
            listUsers = listUsers + `
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="#userPage2" onclick="users('2')">2</a></li>
